...
from data_pipelines.create_tf_datasets_for_projection import ProjectionDatasetReader
from modeling.projection_net_trainer import ProjectionNetModel
...
def main():
    ...
    model = ProjectionNetModel(task=basic_params['task'],
